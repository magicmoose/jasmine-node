...
while (args.length) {
  ...
  switch (arg) {
    ...
    case '--requireJsSetup':
      ...
      if (!existsSync(setup)) throw new Error("RequireJS setup '" + setup + "' doesn't exist!");
    ...
    case '--test-dir':
      ...
      if (!existsSync(dir)) throw new Error("Test root path '" + dir + "' doesn't exist!");
